...
public class ParticleEditor extends Interface implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        emitter = new ParticleEmitterEditor(preview, (float) direction.getValue(), (float) spread.getValue(), (float) size.getValue(), ParticleEmitter.MODE_CONTINUOUS, 100, color.getValue());
